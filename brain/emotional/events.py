...
EVENT_TYPES = {
    ...
    "boundary_dismiss": {
        "primary_need": "respect",
        "primary_delta": -8,
        "secondary": {"autonomy": -3, "security": -2},
        "deep_delta": -2.0,
        "severity": 3,
        "cooldown_minutes": 60,
...
def _make_event(event_type: str, detail: str = "") -> Event:
    """根据事件类型创建 Event 实例（v2.0：增加 emotion_effect）。"""
