...
只返回 JSON：{{"entities":[{{"name":"","entity_type":"person|project|place|event|concept|other","summary":"","current_status":"","confidence":0.0}}],"episodes":[{{"title":"","summary":"","category":"event|project|relationship|other","fragment_ids":[1,2],"entities":[{{"name":"","entity_type":""}}],"occurred_from":"","occurred_to":"","confidence":0.0}}],"sagas":[{{"title":"","summary":"","episode_indices":[0,1],"confidence":0.0,"emotion":{{"valence":-1.0,"arousal":-1.0,"guardedness":-1.0,"connection":-1.0,"immersion":-1.0,"weight":0.0}}}}]}}
